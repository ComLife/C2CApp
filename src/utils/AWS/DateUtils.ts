...
const formatters = {
   ...
   */
  [ISO8601]: (date: any) => date.toISOString(),
   ...
   *     '20170331T000000Z'
   */
  [AMZ_ISO8601]: (date: any) => `${formatters[YYYYMMDD](date)}T000000Z`,
};

//@ts-ignore
export const dateToString = (date: any, format = ISO8601) => formatters[format](date);
